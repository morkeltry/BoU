...
export function Main (props) {
  ...
  useEffect(() => {
    ...
    // even if it changes.
    api.query.ctnimmoTemplateModule
  ...
  }, [digest, api.query.ctnimmoTemplateModule]);
      ...
      <Form success={!!digest && !isClaimed()} warning={isClaimed()}>
        ...
        <Form.Field>
          ...
          <TxButton
            ...
            attrs={{
              palletRpc: 'ctnimmoTemplateModule',
...
export default function CtnimmoTemplateModule (props) {
  const { api } = useSubstrate();
  return (api.query.ctnimmoTemplateModule && api.query.ctnimmoTemplateModule.proofs
    ? <Main {...props} /> : null);
}
